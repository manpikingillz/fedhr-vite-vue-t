<template>
    <!-- Bottom Graphic from https://www.shapedivider.app/  -->
    <div class="custom-shape-divider-bottom-1668946002">
...
// Styling for Bottom Graphing from https://www.shapedivider.app/
.custom-shape-divider-bottom-1668946002 {
    position: absolute;
    bottom: 0;
    left: 0;
    width: 100%;
...
.custom-shape-divider-bottom-1668946002 svg {
    position: relative;
    display: block;
...
.custom-shape-divider-bottom-1668946002 .shape-fill {
    fill: #4A9AE27D;
}
// End of styling for Bottom Graphic
